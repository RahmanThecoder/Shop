...
{
    class Dealer_Customer_Database
    {
        ...
        public bool Insert(Dealer_Customer_class dc)
        {
        ...
        public bool Update(Dealer_Customer_class dc)
        {
            //SQL Connection for Database Connection
            SqlConnection conn = new SqlConnection(myconnstrng);
        ...
        public bool Delete(Dealer_Customer_class dc)
        {
        ...
        public Dealer_Customer_class SearchDealerCustomerForTransaction(string keyword)
        {
            //Create an object for Dealer_Customer_class class
        ...
        public Dealer_Customer_class GetDeaCustIDFromName(string Name)
        {
