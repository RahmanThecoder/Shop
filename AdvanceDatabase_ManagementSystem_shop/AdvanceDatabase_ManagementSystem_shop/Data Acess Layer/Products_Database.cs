    ...
    
{
    class Products_Database
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                //Writing the Query to Select all the tbl_products from database
        ...
        public bool Insert(Products_class p)
        {
        ...
        public bool Update(Products_class p)
        {
        ...
        public bool Delete(Products_class p)
        {
        ...
        public Products_class GetProductsForTransaction(string keyword)
        {
            //Create an object of Products_class and return it
            ...
            try
            {
                ...
                //If we have any values on dt then set the values to Products_class
                if (dt.Rows.Count > 0)
                {
        ...
        public Products_class GetProductIDFromName(string ProductName)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    //Pass the value from dt to Dealer_Customer_class dc
        ...
        #endregion
        #region DESPLAY tbl_products BASED ON CATEGORIES
