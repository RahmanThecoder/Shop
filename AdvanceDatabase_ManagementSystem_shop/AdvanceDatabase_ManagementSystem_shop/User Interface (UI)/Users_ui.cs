...
{
    public partial class Users_ui : Form
    {
        public Users_ui()
        {
            InitializeComponent();
        ...
        Users_class u = new Users_class();
        Users_Database dal = new Users_Database();
        private void clear()
        {
            txtUserID.Text = "";
            txtFirstName.Text = "";
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            Users_class usr = dal.GetIDFromUsername(loggedUser);
        ...
        //Putting Data from Table again with mouseclick into Our TextField
