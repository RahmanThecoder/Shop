...
{
    public partial class Menu_Categoriesui : Form
    {
        public Menu_Categoriesui()
        {
            InitializeComponent();
        }
        ...
        Menu_Categories_class c = new Menu_Categories_class();
        Menu_Categories_Database dal = new Menu_Categories_Database();
        ...
        private void btnADD_Click(object sender, EventArgs e)
        {
            ...
            string loggedUser = loginpage.loggedIn;
            Users_class usr = udal.GetIDFromUsername(loggedUser);
        ...
        private void Menu_Categoriesui_Load(object sender, EventArgs e)
        {
