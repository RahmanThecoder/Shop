...
{
    public partial class Purchase_Sales_ui : Form
    {
        public Purchase_Sales_ui()
        {
            InitializeComponent();
        }
        ...
        Transaction_Details_Database tdDAL = new Transaction_Details_Database();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Dealer_Customer_class dc = dcDAL.GetDeaCustIDFromName(deaCustName);
            ...
            string username = loginpage.loggedIn;
            Users_class u = uDAL.GetIDFromUsername(username);
            ...
            using (TransactionScope scope = new TransactionScope())
            {
                ...
                for (int i = 0; i < transactionDT.Rows.Count; i++)
                {
                    ...
                    Transaction_Details_class transactionDetail = new Transaction_Details_class();
                    //Get the Product name and convert it to id
                    string ProductName = transactionDT.Rows[i][0].ToString();
                    Products_class p = pDAL.GetProductIDFromName(ProductName);
        ...
        private void Purchase_Sales_ui_Load(object sender, EventArgs e)
        {
            //Get the transactionType value from frmUserDashboard
            string type = Employeepage.transactionType;
        ...
        private void txtVat_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txtSearch_TextChanged_1(object sender, EventArgs e)
        {
            ...
            Dealer_Customer_class dc = dcDAL.SearchDealerCustomerForTransaction(keyword);
        ...
        private void txtSearchProduct_TextChanged_1(object sender, EventArgs e)
        {
            ...
            Products_class p = pDAL.GetProductsForTransaction(keyword);
